...
public class EditorActivity extends AppCompatActivity implements
    ...
    // Boolean that keeps track of whether the pet has been edited (true) or not (false).
    private boolean mPetHasChanged = false;

    // OnTouchListener listens for any user touches on a View, implying modification, and we change
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null) {
            ...
            // Initialize a loader to read the pet data from database and display current values
            // in editor.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                // If the pet hasn't changed, continue navigating up to parent (Catalog Activity).
                if (!mPetHasChanged) {
                ...
                // Create click listener to handle user confirming that changes should be discarded.
    ...
    public void onBackPressed() {
        ...
        // Create a click listener to handle user confirming that changes should be discarded.
        DialogInterface.OnClickListener discardButtonClickListener =
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                // User clicked "Keep editing" button, so dismiss the dialog and continue editing pet.
                if (dialog != null) {
                    dialog.dismiss();
                }
            }
    ...
    private void deletePet() {
        ...
        if (mCurrentPetUri != null) {
            // Call the ContentResolver to delete the pet at the given content URI. Pass in null
            // for the selection and selection args because the mCurrentPetUri content URI already
